...
function printError(elemId, hintMsg) {
  ...
  document.getElementById("contactForm").addEventListener("submit",function(e) {
    ...
    let nameValidation = emailValidation = countryValidation = subjectValidation = messageValidation = true;
    ...
    // Validate message
    printError("messageValidation", "");
    if (message == "") {
      printError("messageValidation", "Please enter a message");
    ...
    if (!nameValidation || !emailValidation || !countryValidation || !subjectValidation || !messageValidation) {
